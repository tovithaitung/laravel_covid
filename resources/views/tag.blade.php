        ...
        <table class="c-table">
          <thead class="c-table__head">
            <tr class="c-table__row">
              <th class="c-table__cell c-table__cell--head">Tên Tag</th>
              <th class="c-table__cell c-table__cell--head">Tổng video</th>
          ...
          <tbody>
            <tr class="c-table__row">
              ...
              <td class="c-table__cell"><?php echo $item->tag_name ?></td>
              <td class="c-table__cell"><?php echo $item->total ?></td>
              <td class="c-table__cell"><a href="/tag/@if(empty($item->tag_name)){{'notag'}}@else{{$item->tag_name}}@endif" target="_blank">List Video</a></td>
            </tr>
             <?php } ?>
          </tbody>
        </table>
